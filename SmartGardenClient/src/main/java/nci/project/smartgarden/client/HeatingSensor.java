...
public class HeatingSensor {
    ...
    private static final String API = "/heating";
    ...
    private static final String API_INCREASE_TEMP = "/increase-temperature";
    private static final String API_DECREASE_TEMP = "/decrease-temperature";
    private static final String API_CURRENT_TEMP = "/current-temperature";
    
    private int sensor_port = 0;
    private String sensor_address = "";
    
    public HeatingSensor(String address, int port) {
    ...
    public String increaseTemp() {
        String result = makeRequest(API_INCREASE_TEMP, "");
        return result;
    }
    
    public String decreaseTemp() {
        String result = makeRequest(API_DECREASE_TEMP, "");
        return result;
    }

    public String getCurrentTemp() {
        String result = makeRequest(API_CURRENT_TEMP, "");
        return result;
    }    
